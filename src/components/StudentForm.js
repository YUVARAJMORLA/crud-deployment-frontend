...
function StudentForm(props)
{
    ...
    return(
        <div style={{maxWidth:"40%",margin:"0px auto"}}>
            ...
            <input defaultValue={props.rollNoValue} onChange={(event)=>setRollNo(event.target.value)} className="form-control my-3" placeholder="Enter your rollNo" />
            <button onClick={handleClick} className="btn btn-success d-block mx-auto my-3" type="submit">{props.children}Submit</button>
        </div>
    )
}
